...
module.exports = {
  ...
  async run(bot) {
    ...
    skills = [
      ...
      ["Extra Tasty S","Plat Super Bon S","0","0"],
      ["Helper Boost (Electric)","Super Soutien (Électrik)","0","0"],
    ]
