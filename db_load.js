...
module.exports = {
  ...
  async run(bot) {
    ...
    pokemon1 = [
      ...
      ["Fantominus","Ingrédients","Charge de Puissance S","B"],
      ["Spectrum","Ingrédients","Charge de Puissance S","A"],
      ["Ectoplasma","Ingrédients","Charge de Puissance S","S+"],
